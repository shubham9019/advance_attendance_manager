...
class Home():
    def __init__(self,master):
        ...
        attendance=Label(master,text='Attendance',font=("Arial", 44))
        ...
        print(button_list)
        username_head = Label(master, text='Name:', font=("Arial", 36))
        username_head.grid(row=9, column=0)
        status_head = Label(master, text='Status:', font=("Arial", 36))
        status_head.grid(row=9, column=1)
        for i in range(0, len(store)):
            username[i] = Label(master, text=store[i][0], font=("Arial", 22))
            username[i].grid(row=10 + i, column=0)
            status_list[i] = Label(master, text=store[i][1],font=("Arial", 22))
            status_list[i].grid(row=10+i,column=1)

        #message box code


        message_label=Label(master,text="   Message to Employees",font=("Arial", 44))
